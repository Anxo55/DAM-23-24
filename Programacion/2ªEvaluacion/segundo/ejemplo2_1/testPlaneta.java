...
public class testPlaneta {
 ...
 public static void main(String[] args) {
        ...
        Planeta planeta1 = new Planeta("Marte", 2, 6.4171e23, 1.6318e11, 6779, 227, TipoPlaneta.TERRESTRE, true);
        Planeta planeta2 = new Planeta("Júpiter", 79, 1.898e27, 1.43128e15, 139820, 778, TipoPlaneta.GASEOSO, true);
